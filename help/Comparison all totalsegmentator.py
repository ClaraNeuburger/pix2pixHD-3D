...
output_file = 'comparison_TotalSegmentator.txt'
volume_data_CT = parse_volume_data('Totalsegmentator_CT.txt')
volume_data_sCT = parse_volume_data('Totalsegmentator_sCT.txt')
volume_data_MR = parse_volume_data('TotalSegmentator_MR.txt')
...
path_mr_muslce = f"MR_muscle_Bland_Alman_fig.png"
path_sct_muscle = f"sCT_muscle_Bland_Alman_fig.png"

path_mr_adipose = f"MR_adipose_Bland_Alman_fig.png"
path_sct_adipose = f"sCT_adipose_Bland_Alman_fig.png"

path_mr_torso = f"MR_torso_Bland_Alman_fig.png"
path_sct_torso = f"sCT_torso_Bland_Alman_fig.png"

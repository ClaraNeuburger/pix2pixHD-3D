...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # for displays
        self.parser.add_argument('--display_freq', type=int, default=550, help='frequency of showing training results on screen')
        ...
        # for training
        self.parser.add_argument('--patch_size',type=int, nargs=3,default=(144,144,44),help='patch size for training in 3D')
        self.parser.add_argument('--patch_overlap', type=int, default=16,help='patch overlap for 3D image reconstruction')
        ...
        self.parser.add_argument('--l1_loss', type=float, default=5.0, help='weight for L1 loss')
        self.parser.add_argument('--no_ganFeat_loss', action='store_true', help='if specified, do *not* use discriminator feature matching loss')
        self.parser.add_argument('--vgg_loss', action='store_true', help='if specified, do *not* use VGG feature matching loss')

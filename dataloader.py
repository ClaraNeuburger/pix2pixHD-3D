...
def get_subjects(path, nb_channels, plot_data, transform=None):
...
class Dataset:
    def __init__(self, path, nb_channels, plot_data, title, patch_size, patch_overlap, ratio=0.9, batch_size=1, pretraining=False):
        self.path = path
        ...
        self.subjects = get_subjects(self.path,self.nb_channels, self.plot_data)
